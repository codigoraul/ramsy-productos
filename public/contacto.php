...
$TO_EMAILS_BASE = 'contacto@ramsy.cl, codigoraul@gmail.com, ramsyspa29@gmail.com';
...
$asuntoLabel = $ASUNTOS[$asunto] ?? ($asunto !== '' ? $asunto : 'Sin especificar');
...
$subject = 'Nuevo mensaje de contacto desde ramsy.cl — ' . $asuntoLabel;
...
$bodyHtml = '<!doctype html><html><head><meta charset="UTF-8"></head><body style="font-family:Arial,Helvetica,sans-serif; color:#111827;">'
  . '<h2 style="margin:0 0 16px; font-size:18px;">Nuevo mensaje de contacto — Ramsy</h2>'
...
$bodyText = "Nuevo mensaje de contacto — Ramsy\n\n"
  . "Nombre: {$nombre}\n"
...
$altBoundary = 'ramsy_alt_' . bin2hex(random_bytes(12));
$body = "--{$altBoundary}\r\n"
