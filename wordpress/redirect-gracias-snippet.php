 ...
 * de gracias del frontend headless (ramsy.cl/prueba/gracias), pasando el
 * número de pedido como ?pedido=ID.
 *
 * IMPORTANTE: desplegar primero el frontend (que exista /prueba/gracias)
...
add_action('template_redirect', function () {
    if (function_exists('is_wc_endpoint_url') && is_wc_endpoint_url('order-received')) {
        ...
        wp_redirect('https://ramsy.cl/prueba/gracias' . $suffix);
        exit;
    }
});
